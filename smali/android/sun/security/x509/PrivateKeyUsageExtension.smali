.class public Landroid/sun/security/x509/PrivateKeyUsageExtension;
...
.method public constructor <init>(Ljava/lang/Boolean;Ljava/lang/Object;)V
    ...
    .line 79
    iput-object v0, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->notBefore:Ljava/util/Date;

    .line 80
    iput-object v0, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->notAfter:Ljava/util/Date;

    .line 136
    sget-object v0, Landroid/sun/security/x509/PKIXExtensions;->PrivateKeyUsage_Id:Landroid/sun/security/util/ObjectIdentifier;

    iput-object v0, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->extensionId:Landroid/sun/security/util/ObjectIdentifier;
    ...
    iput-boolean p1, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->critical:Z
    ...
    iput-object p2, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->extensionValue:[B

    .line 140
    new-instance p1, Landroid/sun/security/util/DerInputStream;

    iget-object p2, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->extensionValue:[B

    invoke-direct {p1, p2}, Landroid/sun/security/util/DerInputStream;-><init>([B)V
    ...
    .line 149
    invoke-virtual {v1, p2}, Landroid/sun/security/util/DerValue;->isContextSpecific(B)Z
    ...
    .line 155
    invoke-virtual {v1, v3}, Landroid/sun/security/util/DerValue;->resetTag(B)V
    ...
    .line 157
    invoke-virtual {v2}, Landroid/sun/security/util/DerInputStream;->getGeneralizedTime()Ljava/util/Date;

    move-result-object v1

    iput-object v1, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->notBefore:Ljava/util/Date;
    ...
    .line 159
    invoke-virtual {v1, v2}, Landroid/sun/security/util/DerValue;->isContextSpecific(B)Z
    ...
    iput-object v1, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->notAfter:Ljava/util/Date;
...
.method public constructor <init>(Ljava/util/Date;Ljava/util/Date;)V
    ...
    .line 117
    iput-object p1, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->notBefore:Ljava/util/Date;

    .line 118
    iput-object p2, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->notAfter:Ljava/util/Date;

    .line 120
    sget-object p1, Landroid/sun/security/x509/PKIXExtensions;->PrivateKeyUsage_Id:Landroid/sun/security/util/ObjectIdentifier;

    iput-object p1, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->extensionId:Landroid/sun/security/util/ObjectIdentifier;
    ...
    .line 122
    invoke-direct {p0}, Landroid/sun/security/x509/PrivateKeyUsageExtension;->encodeThis()V
...
.method private encodeThis()V
    ...
    .line 84
    iget-object v0, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->notBefore:Ljava/util/Date;
    ...
    .line 85
    iput-object v0, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->extensionValue:[B
    ...
    .line 93
    iget-object v5, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->notBefore:Ljava/util/Date;

    invoke-virtual {v2, v5}, Landroid/sun/security/util/DerOutputStream;->putGeneralizedTime(Ljava/util/Date;)V
    ...
    .line 99
    iget-object v5, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->notAfter:Ljava/util/Date;
...
.method public encode(Ljava/io/OutputStream;)V
    ...
    .line 232
    iget-object v1, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->extensionValue:[B
    ...
    iput-object v1, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->extensionId:Landroid/sun/security/util/ObjectIdentifier;

    const/4 v1, 0x0

    .line 234
    iput-boolean v1, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->critical:Z
...
.method public set(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    iput-object p2, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->notBefore:Ljava/util/Date;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->notBefore:Ljava/util/Date;
    ...
    iget-object v1, p0, Landroid/sun/security/x509/PrivateKeyUsageExtension;->notAfter:Ljava/util/Date;
...
.method public valid()V
    ...
    .line 195
    invoke-virtual {p0, v0}, Landroid/sun/security/x509/PrivateKeyUsageExtension;->valid(Ljava/util/Date;)V

...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/liulishuo/okdownload/core/file/MultiPointOutputStream;->FILE_IO_EXECUTOR:Ljava/util/concurrent/ExecutorService;
...
.method declared-synchronized close(I)V
    ...
    check-cast v1, Lcom/liulishuo/okdownload/core/file/DownloadOutputStream;

    if-eqz v1, :cond_0

    .line 282
    invoke-interface {v1}, Lcom/liulishuo/okdownload/core/file/DownloadOutputStream;->close()V
...
.method public done(I)V
    ...
    const-string v0, "OutputStream done but no need to ensure sync, because the sync job not run yet. task["

    const-string v1, "OutputStream done but no need to ensure sync, because the syncFuture.isDone["
...
.method flushProcess()V
    ...
    const-string v4, "[noSyncLengthMap size]: "

    invoke-direct {v3, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-virtual {v3, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v4, " [outputStreamMap size]:"
...
.method declared-synchronized outputStream(I)Lcom/liulishuo/okdownload/core/file/DownloadOutputStream;
    ...
    const-string v0, "Create output stream write from ("
    ...
    check-cast v2, Lcom/liulishuo/okdownload/core/file/DownloadOutputStream;
    ...
    invoke-virtual {v2}, Lcom/liulishuo/okdownload/DownloadTask;->getUri()Landroid/net/Uri;

    move-result-object v2

    invoke-static {v2}, Lcom/liulishuo/okdownload/core/Util;->isUriFileScheme(Landroid/net/Uri;)Z
    ...
    invoke-virtual {v4}, Lcom/liulishuo/okdownload/DownloadTask;->getParentFile()Ljava/io/File;
    ...
    invoke-static {v4, v1}, Lcom/liulishuo/okdownload/core/Util;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3}, Lcom/liulishuo/okdownload/OkDownload;->outputStreamFactory()Lcom/liulishuo/okdownload/core/file/DownloadOutputStream$Factory;
    ...
    invoke-virtual {v4}, Lcom/liulishuo/okdownload/OkDownload;->context()Landroid/content/Context;

    move-result-object v4

    iget v5, p0, Lcom/liulishuo/okdownload/core/file/MultiPointOutputStream;->flushBufferSize:I

    .line 541
    invoke-interface {v3, v4, v1, v5}, Lcom/liulishuo/okdownload/core/file/DownloadOutputStream$Factory;->create(Landroid/content/Context;Landroid/net/Uri;I)Lcom/liulishuo/okdownload/core/file/DownloadOutputStream;

    move-result-object v1

    .line 545
    iget-boolean v3, p0, Lcom/liulishuo/okdownload/core/file/MultiPointOutputStream;->supportSeek:Z
    ...
    .line 546
    iget-object v3, p0, Lcom/liulishuo/okdownload/core/file/MultiPointOutputStream;->info:Lcom/liulishuo/okdownload/core/breakpoint/BreakpointInfo;

    invoke-virtual {v3, p1}, Lcom/liulishuo/okdownload/core/breakpoint/BreakpointInfo;->getBlock(I)Lcom/liulishuo/okdownload/core/breakpoint/BlockInfo;

    move-result-object v3

    invoke-virtual {v3}, Lcom/liulishuo/okdownload/core/breakpoint/BlockInfo;->getRangeLeft()J
    ...
    .line 549
    invoke-interface {v1, v6, v7}, Lcom/liulishuo/okdownload/core/file/DownloadOutputStream;->seek(J)V
    ...
    .line 555
    :cond_5
    iget-boolean v0, p0, Lcom/liulishuo/okdownload/core/file/MultiPointOutputStream;->firstOutputStream:Z
    ...
    invoke-interface {v0, v3}, Lcom/liulishuo/okdownload/core/breakpoint/DownloadStore;->markFileDirty(I)Z

    .line 559
    :cond_6
    iget-object v0, p0, Lcom/liulishuo/okdownload/core/file/MultiPointOutputStream;->info:Lcom/liulishuo/okdownload/core/breakpoint/BreakpointInfo;

    invoke-virtual {v0}, Lcom/liulishuo/okdownload/core/breakpoint/BreakpointInfo;->isChunked()Z
    ...
    iget-boolean v0, p0, Lcom/liulishuo/okdownload/core/file/MultiPointOutputStream;->isPreAllocateLength:Z
    ...
    invoke-virtual {p0, v4, v2, v3}, Lcom/liulishuo/okdownload/core/file/MultiPointOutputStream;->inspectFreeSpace(Landroid/os/StatFs;J)V

    .line 567
    invoke-interface {v1, v6, v7}, Lcom/liulishuo/okdownload/core/file/DownloadOutputStream;->setLength(J)V
...
.method runSync()V
    ...
    const-string v5, "isNoMoreStream["
    ...
    .line 414
    const-string v0, "The sync thread ready to exist the loop by break."
...
.method runSyncDelayException()V
    ...
    .line 365
    const-string v0, "Sync to breakpoint-store for task["
    ...
    const-string v0, "] [This exception isn\'t IOException!]"
    ...
    .line 367
    iput-object v2, p0, Lcom/liulishuo/okdownload/core/file/MultiPointOutputStream;->syncException:Ljava/io/IOException;
    ...
    const-string v0, "] failed with cause: "

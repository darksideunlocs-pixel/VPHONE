...
.method private static delayProcess()V
    ...
    const-string v1, "--->>> autoProcess: Build envelope error code: "
    ...
    invoke-static {v6}, Lcom/umeng/commonsdk/framework/UMModuleRegister;->getCallbackFromModuleName(Ljava/lang/String;)Lcom/umeng/commonsdk/framework/UMLogDataProtocol;
    ...
    .line 143
    :try_start_0
    invoke-interface {v6, v4, v5}, Lcom/umeng/commonsdk/framework/UMLogDataProtocol;->setupReportData(J)Lorg/json/JSONObject;
    ...
    .line 157
    invoke-static {v2, v5, v4}, Lcom/umeng/commonsdk/framework/UMEnvelopeBuild;->buildEnvelopeWithExtHeader(Landroid/content/Context;Lorg/json/JSONObject;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    .line 169
    invoke-interface {v6, v4}, Lcom/umeng/commonsdk/framework/UMLogDataProtocol;->removeCacheData(Ljava/lang/Object;)V
    :try_end_2
...
.method private static declared-synchronized init()V
    ...
    const-string/jumbo v2, "work_thread"

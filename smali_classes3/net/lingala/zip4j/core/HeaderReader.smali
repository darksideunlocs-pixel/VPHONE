...
.method public readLocalFileHeader(Lnet/lingala/zip4j/model/FileHeader;)Lnet/lingala/zip4j/model/LocalFileHeader;
    ...
    .line 860
    invoke-virtual {v6, v14}, Lnet/lingala/zip4j/model/LocalFileHeader;->setSignature(I)V

    .line 864
    iget-object v3, v1, Lnet/lingala/zip4j/core/HeaderReader;->zip4jRaf:Ljava/io/RandomAccessFile;

    invoke-direct {v1, v3, v10}, Lnet/lingala/zip4j/core/HeaderReader;->readIntoBuff(Ljava/io/RandomAccessFile;[B)[B

    .line 865
    invoke-static {v10, v13}, Lnet/lingala/zip4j/util/Raw;->readShortLittleEndian([BI)I

    move-result v3

    invoke-virtual {v6, v3}, Lnet/lingala/zip4j/model/LocalFileHeader;->setVersionNeededToExtract(I)V
    ...
    :goto_0
    invoke-virtual {v6, v3}, Lnet/lingala/zip4j/model/LocalFileHeader;->setFileNameUTF8Encoded(Z)V
    ...
    .line 874
    invoke-virtual {v6, v7}, Lnet/lingala/zip4j/model/LocalFileHeader;->setEncrypted(Z)V

    .line 876
    :cond_2
    invoke-virtual {v6, v10}, Lnet/lingala/zip4j/model/LocalFileHeader;->setGeneralPurposeFlag([B)V
    ...
    :goto_1
    invoke-virtual {v6, v8}, Lnet/lingala/zip4j/model/LocalFileHeader;->setDataDescriptorExists(Z)V

    .line 885
    :cond_4
    iget-object v8, v1, Lnet/lingala/zip4j/core/HeaderReader;->zip4jRaf:Ljava/io/RandomAccessFile;

    invoke-direct {v1, v8, v10}, Lnet/lingala/zip4j/core/HeaderReader;->readIntoBuff(Ljava/io/RandomAccessFile;[B)[B
    ...
    invoke-virtual {v6, v8}, Lnet/lingala/zip4j/model/LocalFileHeader;->setCompressionMethod(I)V

    .line 890
    iget-object v8, v1, Lnet/lingala/zip4j/core/HeaderReader;->zip4jRaf:Ljava/io/RandomAccessFile;

    invoke-direct {v1, v8, v12}, Lnet/lingala/zip4j/core/HeaderReader;->readIntoBuff(Ljava/io/RandomAccessFile;[B)[B
    ...
    invoke-virtual {v6, v8}, Lnet/lingala/zip4j/model/LocalFileHeader;->setLastModFileTime(I)V
    ...
    invoke-virtual {v6, v7}, Lnet/lingala/zip4j/model/LocalFileHeader;->setCrcBuff([B)V
    ...
    .line 903
    invoke-static {v7, v13}, Lnet/lingala/zip4j/util/Raw;->readLongLittleEndian([BI)J
    ...
    .line 921
    invoke-virtual {v6, v8}, Lnet/lingala/zip4j/model/LocalFileHeader;->setExtraFieldLength(I)V
    ...
    .line 944
    invoke-virtual {v6, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setFileName(Ljava/lang/String;)V
    ...
    .line 951
    invoke-virtual {v6, v4, v5}, Lnet/lingala/zip4j/model/LocalFileHeader;->setOffsetStartOfData(J)V
    ...
    invoke-virtual {v6, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setPassword([C)V
    ...
    .line 967
    invoke-virtual {v6, v11}, Lnet/lingala/zip4j/model/LocalFileHeader;->setEncryptionMethod(I)V

    goto :goto_3

    .line 969
    :cond_9
    invoke-virtual {v6, v13}, Lnet/lingala/zip4j/model/LocalFileHeader;->setEncryptionMethod(I)V
    ...
    invoke-virtual {v6, v2, v3}, Lnet/lingala/zip4j/model/LocalFileHeader;->setCrc32(J)V
    ...
    invoke-virtual {v6, v0}, Lnet/lingala/zip4j/model/LocalFileHeader;->setCrcBuff([B)V
    ...
    invoke-virtual {v6, v2, v3}, Lnet/lingala/zip4j/model/LocalFileHeader;->setCompressedSize(J)V
    ...
    invoke-virtual {v6, v2, v3}, Lnet/lingala/zip4j/model/LocalFileHeader;->setUncompressedSize(J)V

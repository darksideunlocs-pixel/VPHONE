...
.method public append(Ljava/lang/CharSequence;)V
    ...
    new-instance v1, Lorg/apache/commons/codec/language/bm/PhoneticEngine$PhonemeBuilder$$ExternalSyntheticLambda2;

    invoke-direct {v1, p1}, Lorg/apache/commons/codec/language/bm/PhoneticEngine$PhonemeBuilder$$ExternalSyntheticLambda2;-><init>(Ljava/lang/CharSequence;)V

    invoke-static {v0, v1}, Lorg/conscrypt/Platform$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/Set;Ljava/util/function/Consumer;)V
...
.method public apply(Lorg/apache/commons/codec/language/bm/Rule$PhonemeExpr;I)V
    ...
    invoke-interface {p1}, Lorg/apache/commons/codec/language/bm/Rule$PhonemeExpr;->size()I
...
.method public makeString()Ljava/lang/String;
    ...
    invoke-direct {v1}, Lorg/apache/commons/codec/language/bm/PhoneticEngine$PhonemeBuilder$$ExternalSyntheticLambda1;-><init>()V

    invoke-static {v0, v1}, Lorg/conscrypt/Platform$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/Stream;Ljava/util/function/Function;)Ljava/util/stream/Stream;

    move-result-object v0

    const-string v1, "|"

    invoke-static {v1}, Lorg/conscrypt/Platform$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/CharSequence;)Ljava/util/stream/Collector;

    move-result-object v1

    invoke-static {v0, v1}, Lokhttp3/Headers$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/Stream;Ljava/util/stream/Collector;)Ljava/lang/Object;

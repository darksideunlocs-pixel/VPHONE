...
.method private static getSignerCert(Lorg/bouncycastle/asn1/ocsp/BasicOCSPResponse;Ljava/security/cert/X509Certificate;Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/util/JcaJceHelper;)Ljava/security/cert/X509Certificate;
    ...
    invoke-virtual {p0, p3}, Lorg/bouncycastle/asn1/x500/X500Name;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {p2, p3}, Lorg/bouncycastle/asn1/x500/X500Name;->getInstance(Lorg/bouncycastle/asn1/x500/X500NameStyle;Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/X500Name;
...
.method static validatedOcspResponse(Lorg/bouncycastle/asn1/ocsp/BasicOCSPResponse;Lorg/bouncycastle/jcajce/PKIXCertRevocationCheckerParameters;[BLjava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/util/JcaJceHelper;)Z
    ...
    invoke-virtual {p3, p4}, Lorg/bouncycastle/asn1/ocsp/ResponseData;->getEncoded(Ljava/lang/String;)[B
...
.method public check(Ljava/security/cert/Certificate;)V
    ...
    invoke-static {v0}, Lorg/bouncycastle/jce/provider/ProvRevocationChecker$$ExternalSyntheticApiModelOutline0;->m(Lorg/bouncycastle/jce/provider/ProvRevocationChecker;)Ljava/util/Map;
    ...
    invoke-static {v1}, Lorg/bouncycastle/jce/provider/ProvRevocationChecker$$ExternalSyntheticApiModelOutline0;->m(Lorg/bouncycastle/jce/provider/ProvRevocationChecker;)Ljava/net/URI;
    ...
    invoke-static {v1}, Lorg/bouncycastle/jce/provider/ProvRevocationChecker$$ExternalSyntheticApiModelOutline0;->m(Lorg/bouncycastle/jce/provider/ProvRevocationChecker;)Ljava/security/cert/X509Certificate;

    move-result-object v5

    iget-object v1, p0, Lorg/bouncycastle/jce/provider/ProvOcspRevocationChecker;->parent:Lorg/bouncycastle/jce/provider/ProvRevocationChecker;

    invoke-static {v1}, Lorg/bouncycastle/jce/provider/ProvRevocationChecker$$ExternalSyntheticApiModelOutline0;->m(Lorg/bouncycastle/jce/provider/ProvRevocationChecker;)Ljava/util/List;
    ...
    :try_start_1
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/ocsp/OCSPResponse;->getEncoded()[B
    ...
    invoke-static {v4}, Lorg/conscrypt/Platform$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Ljava/security/cert/Extension;

    move-result-object v4

    invoke-static {v4}, Lorg/conscrypt/Platform$$ExternalSyntheticApiModelOutline0;->m(Ljava/security/cert/Extension;)[B
    ...
    invoke-static {v4}, Lorg/conscrypt/Platform$$ExternalSyntheticApiModelOutline0;->m(Ljava/security/cert/Extension;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v3}, Lorg/bouncycastle/asn1/ASN1Integer;->equals(Lorg/bouncycastle/asn1/ASN1Primitive;)Z

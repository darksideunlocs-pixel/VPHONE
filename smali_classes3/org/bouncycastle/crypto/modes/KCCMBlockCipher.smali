...
.method public processPacket([BII[BI)I
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/modes/KCCMBlockCipher;->macBlock:[B
    ...
    :goto_5
    iget-object v7, p0, Lorg/bouncycastle/crypto/modes/KCCMBlockCipher;->counter:[B
    ...
    invoke-interface {v1, v7, v6, v8, v6}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I

    const/4 v1, 0x0

    :goto_6
    iget v7, p0, Lorg/bouncycastle/crypto/modes/KCCMBlockCipher;->macSize:I
    ...
    iget-object v7, p0, Lorg/bouncycastle/crypto/modes/KCCMBlockCipher;->buffer:[B

    invoke-interface {v1, v2, v6, v7, v6}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    invoke-static {p4, v2, v7, v6, v1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget v1, p0, Lorg/bouncycastle/crypto/modes/KCCMBlockCipher;->macSize:I

    sub-int/2addr v5, v1

    invoke-direct {p0, p4, v6, v5}, Lorg/bouncycastle/crypto/modes/KCCMBlockCipher;->CalculateMac([BII)V

    iget-object v1, p0, Lorg/bouncycastle/crypto/modes/KCCMBlockCipher;->macBlock:[B

    iget-object v2, p0, Lorg/bouncycastle/crypto/modes/KCCMBlockCipher;->mac:[B

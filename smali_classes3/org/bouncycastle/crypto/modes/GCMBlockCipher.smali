...
.method public doFinal([BI)I
    ...
    invoke-direct/range {v0 .. v5}, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->processPartial([BII[BI)V

    :cond_3
    iget-wide v1, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->atLength:J

    iget v5, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->atBlockPos:I
    ...
    invoke-direct {p0, v1, v2, v13, v5}, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->gHASHPartial([B[BII)V

    :cond_4
    iget-wide v1, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->atLengthPre:J
    ...
    iget-object v6, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->exp:Lorg/bouncycastle/crypto/modes/gcm/GCMExponentiator;
    ...
    iput-object v6, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->exp:Lorg/bouncycastle/crypto/modes/gcm/GCMExponentiator;

    iget-object v7, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->H:[B

    invoke-interface {v6, v7}, Lorg/bouncycastle/crypto/modes/gcm/GCMExponentiator;->init([B)V

    :cond_6
    iget-object v6, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->exp:Lorg/bouncycastle/crypto/modes/gcm/GCMExponentiator;

    invoke-interface {v6, v1, v2, v5}, Lorg/bouncycastle/crypto/modes/gcm/GCMExponentiator;->exponentiateX(J[B)V

    iget-object v1, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->S_at:[B

    invoke-static {v1, v5}, Lorg/bouncycastle/crypto/modes/gcm/GCMUtil;->multiply([B[B)V
    ...
    invoke-static {v5, v6, v1, v13}, Lorg/bouncycastle/util/Pack;->longToBigEndian(J[BI)V

    iget-wide v5, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->totalLength:J

    mul-long v5, v5, v10

    const/16 v2, 0x8

    invoke-static {v5, v6, v1, v2}, Lorg/bouncycastle/util/Pack;->longToBigEndian(J[BI)V
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->J0:[B

    invoke-interface {v2, v5, v13, v1, v13}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    :goto_2
    invoke-direct {p0, v13}, Lorg/bouncycastle/crypto/modes/GCMBlockCipher;->reset(Z)V

...
.method private procedure_A(II[Ljava/math/BigInteger;I)I
    ...
    invoke-virtual {v11, v14}, Ljava/math/BigInteger;->divide(Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method private procedure_Aa(JJ[Ljava/math/BigInteger;I)J
    ...
    mul-int/lit8 v9, v11, 0x20

    invoke-virtual {v1, v9}, Ljava/math/BigInteger;->pow(I)Ljava/math/BigInteger;
    ...
    invoke-virtual {v14, v2, v3}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {v2, v12}, Ljava/math/BigInteger;->compareTo(Ljava/math/BigInteger;)I
...
.method private procedure_B(II[Ljava/math/BigInteger;)V
    ...
    invoke-virtual {v15, v5, v2}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method private procedure_Bb(JJ[Ljava/math/BigInteger;)V
    ...
    invoke-virtual {v8, v5, v2}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method public generateParameters()Lorg/bouncycastle/crypto/params/GOST3410Parameters;
    ...
    invoke-direct {p0, v0, v3, v6}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->procedure_B(II[Ljava/math/BigInteger;)V
    ...
    :cond_1
    invoke-direct {p0, v0, v3, v6, v2}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->procedure_A(II[Ljava/math/BigInteger;I)I
    ...
    invoke-direct {p0, v1, v2}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->procedure_C(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-direct {v6, v0, v3}, Lorg/bouncycastle/crypto/params/GOST3410ValidationParameters;-><init>(II)V

    invoke-direct {v5, v1, v2, v4, v6}, Lorg/bouncycastle/crypto/params/GOST3410Parameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lorg/bouncycastle/crypto/params/GOST3410ValidationParameters;)V
    ...
    invoke-direct {p0, v0, v6}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->procedure_C(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v7

    new-instance v8, Lorg/bouncycastle/crypto/params/GOST3410Parameters;

    new-instance v9, Lorg/bouncycastle/crypto/params/GOST3410ValidationParameters;

    invoke-direct {v9, v2, v3, v4, v5}, Lorg/bouncycastle/crypto/params/GOST3410ValidationParameters;-><init>(JJ)V

    invoke-direct {v8, v0, v6, v7, v9}, Lorg/bouncycastle/crypto/params/GOST3410Parameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lorg/bouncycastle/crypto/params/GOST3410ValidationParameters;)V

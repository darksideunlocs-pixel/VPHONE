...
.method private static pointDouble([I[I)V
    ...
    invoke-static {v0, p0, p1}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->mul([II[I)V
...
.method public static scalarMult([BI[BI[BI)V
    ...
    invoke-static {p2, p3, p0}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->decode([BI[I)V
    ...
    invoke-static {p0, p2, p1, p2}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->copy([II[II)V
    ...
    :goto_0
    invoke-static {v2, v3, v4}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->add([I[I[I)V

    invoke-static {v2, v3, v2}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->sub([I[I[I)V

    invoke-static {p1, p3, v3}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->add([I[I[I)V

    invoke-static {p1, p3, p1}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->sub([I[I[I)V

    invoke-static {v4, p1, v4}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->mul([I[I[I)V

    invoke-static {v2, v3, v2}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->mul([I[I[I)V

    invoke-static {v3, v3}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->sqr([I[I)V

    invoke-static {p1, p1}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->sqr([I[I)V

    invoke-static {v3, p1, v5}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->sub([I[I[I)V

    const v8, 0x98aa

    invoke-static {v5, v8, p3}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->mul([II[I)V

    invoke-static {p3, p1, p3}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->add([I[I[I)V

    invoke-static {p3, v5, p3}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->mul([I[I[I)V

    invoke-static {p1, v3, p1}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->mul([I[I[I)V

    invoke-static {v4, v2, v3}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->sub([I[I[I)V

    invoke-static {v4, v2, v2}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->add([I[I[I)V

    invoke-static {v2, v2}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->sqr([I[I)V

    invoke-static {v3, v3}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->sqr([I[I)V

    invoke-static {v3, p0, v3}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->mul([I[I[I)V
    ...
    invoke-static {v7, p1, v2}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->cswap(I[I[I)V

    invoke-static {v7, p3, v3}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->cswap(I[I[I)V
    ...
    :cond_0
    invoke-static {p3, p3}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->inv([I[I)V

    invoke-static {p1, p3, p1}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->mul([I[I[I)V

    invoke-static {p1}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->normalize([I)V

    invoke-static {p1, p4, p5}, Lorg/bouncycastle/math/ec/rfc7748/X448$F;->encode([I[BI)V

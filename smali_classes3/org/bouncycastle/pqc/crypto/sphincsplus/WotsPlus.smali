...
.method chain([BII[BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;)[B
    ...
    invoke-virtual {v6, v0}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setHashAddress(I)V

    iget-object p2, v1, Lorg/bouncycastle/pqc/crypto/sphincsplus/WotsPlus;->engine:Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine;

    invoke-virtual {p2, v5, v6, p1}, Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine;->F([BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;[B)[B
...
.method public pkFromSig([B[B[BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;)[B
    ...
    invoke-virtual {p0, p2, v0, v1}, Lorg/bouncycastle/pqc/crypto/sphincsplus/WotsPlus;->base_w([BII)[I
    ...
    invoke-static {p2, v0}, Lorg/bouncycastle/util/Arrays;->concatenate([I[I)[I
    ...
    invoke-virtual {p4, v10}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setChainAddress(I)V
    ...
    invoke-static {p1, v0, v1, v7, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    :cond_1
    invoke-virtual {v6, v8}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setType(I)V
    ...
    invoke-static {v9}, Lorg/bouncycastle/util/Arrays;->concatenate([[B)[B

    move-result-object p2

    invoke-virtual {p1, p3, v6, p2}, Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine;->T_l([BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;[B)[B
...
.method public sign([B[B[BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;)[B
    ...
    invoke-direct {v5, p4}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;-><init>(Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;)V
    ...
    invoke-virtual {v5, v7}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setChainAddress(I)V

    invoke-virtual {v5, p4}, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->setHashAddress(I)V

    iget-object v0, p0, Lorg/bouncycastle/pqc/crypto/sphincsplus/WotsPlus;->engine:Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine;

    invoke-virtual {v0, p2, v5}, Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine;->PRF([BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;)[B

...
.method public constructor <init>(ZIIIIII)V
    ...
    iput-object p2, p1, Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine$Shake256Engine;->treeDigest:Lorg/bouncycastle/crypto/Xof;
...
.method H([BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;[B[B)[B
    ...
    iget-boolean p4, p0, Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine$Shake256Engine;->robust:Z
    ...
    :cond_0
    iget p4, p0, Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine$Shake256Engine;->N:I
    ...
    invoke-interface {p1, v1, v3, p2}, Lorg/bouncycastle/crypto/Xof;->update([BII)V

    iget-object p1, p0, Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine$Shake256Engine;->treeDigest:Lorg/bouncycastle/crypto/Xof;

    array-length p2, p3

    invoke-interface {p1, p3, v3, p2}, Lorg/bouncycastle/crypto/Xof;->update([BII)V
...
.method H_msg([B[B[B[B)Lorg/bouncycastle/pqc/crypto/sphincsplus/IndexedDigest;
    ...
    iget v3, p0, Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine$Shake256Engine;->D:I

    div-int/2addr v2, v3

    iget v3, p0, Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine$Shake256Engine;->H:I
...
.method PRF([BLorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;)[B
    ...
    iget-object v0, p2, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->value:[B

    iget-object p2, p2, Lorg/bouncycastle/pqc/crypto/sphincsplus/ADRS;->value:[B

    array-length p2, p2

    invoke-interface {p1, v0, v2, p2}, Lorg/bouncycastle/crypto/Xof;->update([BII)V

    iget p1, p0, Lorg/bouncycastle/pqc/crypto/sphincsplus/SPHINCSPlusEngine$Shake256Engine;->N:I
    ...
    invoke-interface {p2, p1, v2, v0}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I

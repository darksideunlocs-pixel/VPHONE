...
.method public static final openZip(Lokio/Path;Lokio/FileSystem;Lkotlin/jvm/functions/Function1;)Lokio/ZipFileSystem;
    ...
    .line 105
    invoke-interface {v7}, Lokio/BufferedSource;->readLongLe()J
    ...
    check-cast v12, Lokio/BufferedSource;

    .line 111
    invoke-interface {v12}, Lokio/BufferedSource;->readIntLe()I
    ...
    .line 118
    invoke-static {v12, v10}, Lokio/internal/ZipFilesKt;->readZip64EocdRecord(Lokio/BufferedSource;Lokio/internal/EocdRecord;)Lokio/internal/EocdRecord;
    ...
    invoke-virtual {v5, v12, v13}, Lokio/FileHandle;->source(J)Lokio/Source;
    ...
    .line 128
    invoke-static {v7}, Lokio/internal/ZipFilesKt;->readEntry(Lokio/BufferedSource;)Lokio/internal/ZipEntry;

    move-result-object v14

    .line 129
    invoke-virtual {v14}, Lokio/internal/ZipEntry;->getOffset()J
    ...
    invoke-direct {v5, v0, v1, v2, v11}, Lokio/ZipFileSystem;-><init>(Lokio/Path;Lokio/FileSystem;Ljava/util/Map;Ljava/lang/String;)V
    :try_end_d
